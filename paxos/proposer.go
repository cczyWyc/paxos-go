...
// Propose send a proposal request to the peers
func (p *Proposer) Propose(proposal *Proposal) error {
	// step1: prepare proposals until majority is reached
	...
	// step2: Propose the value agreed on by majority of acceptors
...
// If the proposer receives the request responses from a majority of
